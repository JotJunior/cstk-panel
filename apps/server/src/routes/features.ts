  ...
  server.get('/features', async (request, reply) => {
    ...
    try {
      ...
      const data = features.map(r => ({
        ...
        totalOndas: r.total_waves,
        totalBloqueios: r.total_blocks,
        etapaCorrente: r.current_stage,
    ...
    try {
      ...
      const data = {
        ...
        rollup: {
          ...
          totalOndas: featureRollup.total_waves,
          totalBloqueios: featureRollup.total_blocks,
          etapaCorrente: featureRollup.current_stage,
